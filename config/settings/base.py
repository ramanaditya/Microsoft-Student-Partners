...
APPS_DIR = ROOT_DIR.path("microsoft_student_partners")
...
LOCAL_APPS = [
    ...
    "microsoft_student_partners.twitter.apps.TwitterConfig",
]
...
MIGRATION_MODULES = {"sites": "microsoft_student_partners.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "microsoft_student_partners.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "microsoft_student_partners.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "microsoft_student_partners.users.adapters.SocialAccountAdapter"
